...
<section class="archive-hero">
    <div class="container">
        ...
        <nav class="breadcrumb">
            <a href="<?php echo home_url(); ?>">Home</a> <span>/</span> Platforms
        </nav>
    </div>
</section>
...
<section class="archive-main">
    <div class="container">
        ...
        <div class="filter-tabs">
            ...
            <?php
            // Get IDs of all platforms to filter relevant categories
            $platform_ids = get_posts(['post_type' => 'platform', 'posts_per_page' => -1, 'fields' => 'ids']);
            $terms = get_terms(['taxonomy' => 'category', 'hide_empty' => true, 'object_ids' => $platform_ids]);
            ...
            <?php if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post(); ?>
                <article class="lesys-card">
                    ...
                    <div class="card-content">
                        ...
                        <a href="<?php the_permalink(); ?>" class="card-link">Explore platform →</a>
                    </div>
                </article>
